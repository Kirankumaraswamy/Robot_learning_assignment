...
def train_online(env, agent, num_episodes, eval_cycle, num_eval_episodes, model_dir="./models_cartpole",
    ...
    for i in range(num_episodes):
        ...
        if i % eval_cycle == 0:
            ...
            for j in range(num_eval_episodes):
                ...
                valid_reward += eval_stats.episode_reward
...
if __name__ == "__main__":
    ...
    agent = DQNAgent(q_network, q_target_network, num_actions, gamma=0.9, batch_size=32, epsilon=0.1, tau=0.01,
                     lr=0.001, history_length=0, sampling_probability=[0.5, 0.5])
    train, validation = train_online(env, agent, 200, eval_cycle, num_eval_episodes)
    print("Train reward: ", train)
    print("validation reward: ", validation)